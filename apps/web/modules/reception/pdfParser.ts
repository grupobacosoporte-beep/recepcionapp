...
// --- Fix Vercel serverless para pdf.js-extract ---
// pdf.js busca su worker con un require relativo './pdf.worker.js' que Next
// no incluye en el bundle serverless. Lo inyectamos por globalThis (usa el hilo
// principal) y de paso el require estático hace que Next SÍ incluya el archivo.
try {
  // eslint-disable-next-line @typescript-eslint/no-var-requires
  (globalThis as any).pdfjsWorker = require("pdf.js-extract/lib/pdfjs/pdf.worker.js");
} catch {
  // en local ya funciona por la ruta relativa; ignoramos el fallo aquí
}
// --- fin fix ---
